...
<body>
<div id="app">
    <main class="py-4 dashboard-background h-full">
        <div class="h-12 w-full flex justify-around text-white text-lg">
            ...
            <div class="flex justify-around">
                <div class="mr-12">Courses</div>
                <div class="mr-12">Sign Up</div>
                <div>Sign In</div>
            </div>
        </div>

        <div class="flex justify-center">
            <div class="text-white text-lg mt-64 w-1/3">
                <div class="text-3xl font-bold">Take the fast track to learning a new instrument</div>
                <div>Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod.</div>
                <div class="bg-pink w-1/2 p-2 mt-4 rounded uppercase flex justify-center">Subscribe</div>
            </div>
        ...
        <div class="flex justify-center mt-12">
            <img src="../../images/chevron-down-wide@3x.png"></img>
        </div>

        <div class="flex justify-around mt-12 mx-64">
            <div>
        ...
        <div class="flex justify-around mt-12 mx-64">
            <div class="w-1/3">
                ...
                <div class="text-black text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
            </div>
            <div class="w-1/3">
                <div class="text-pink text-lg text-center">Developmentally Appropriate Content</div>
                <div class="text-black text-center">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
            </div>
            <div class="w-1/3">
                <div class="text-pink text-lg text-center">Downloadable Lessons</div>
                <div class="text-black text-center">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</div>
            </div>
        </div>
